...
"Mietpreis: <t color='#8cff9b'>$%1</t><br/>Kaufpreis: <t color='#8cff9b'>$%2</t><br/>Max Geschwindigkeit: %3 km/h<br/>PS: %4<br/>Passagiersitze: %5<br/>Kofferraum: %6<br/>Tankinhalt: %7<br/>Panzerung: %8",
