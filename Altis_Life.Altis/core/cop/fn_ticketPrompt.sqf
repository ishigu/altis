...
_control ctrlSetStructuredText parseText format["<t align='center'><t size='.8px'>%1 hat dir ein Ticket in Hoehe von $%2 ausgestellt",name _cop,_val];
...
[] spawn
{
	...
	{
		[[0,format["%1 weigert sich das Ticket zu bezahlen.",name player]],"life_fnc_broadcast",west,false] spawn life_fnc_MP;
		[[1,format["%1 weigert sich das Ticket zu bezahlen.",name player]],"life_fnc_broadcast",life_ticket_cop,false] spawn life_fnc_MP;
	};
};