...
if(count _sellers == 0) exitWith {hint "Ich habe aktuell keinerlei Informationen."}; //No data.
...
hint parseText format["Die folgenden Spieler haben diesem Dealer etwas verkauft:<br/><br/>%1",_names];
