...
if((_vehicle getVariable ["trunk_in_use",false])) exitWith {hint "Es ist bereits jemand am Kofferraum."};
...
if(_veh_data select 0 == -1) exitWith {closeDialog 0; _vehicle setVariable["trunk_in_use",false,true]; hint "Dieses Fahrzeug besitzt keinen Kofferraum";};
