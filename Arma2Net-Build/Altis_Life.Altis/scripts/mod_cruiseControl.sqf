...
compileFinal "
	...
	uwg_cruise_control = uwg_cruise addAction ['Tempomat aktivieren','["""""""",call mod_cruiseControlMenu,player,false] spawn BIS_fnc_MP;',[], 0, false, false, '', 'driver uwg_cruise == player'];"",
...
compileFinal "
	...
	if (_xy > 45 && _xy < 55) then {
		...
		hint parseText format [""
					...
					<t size='0.90' font='puristaLight' align='left' color='#0D82DF'>Geschwindigkeit</t><t size='0.90' font='puristaLight'align='right' color='#0D82DF'>Cruise Geschwindigkeit</t><br/>
					...
					<t size='0.90' font='puristaLight' align='center' color='#CC9900'>um aus dem Cruise-Modus zu gehen bremse mit (S)</t><br/><br/>
					<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>- Tempomatstatus -</t><br/>""
				];
	};
		...
		(findDisplay 46) displayAddEventHandler [""KeyDown"",""
			...
			if (_keyDown == 0x1F) then {
				if (cruiseControlSet) then {
					...
					hint parseText format [""""
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Tempomat</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Cruise Control:</t><t size='0.90 'font='puristaLight' align='left' color='#990000'> Deaktiviert!</t><br/><br/>
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>- Tempomatstatus -</t><br/>""""
							];
				};
			};""];
	...
	while {cruiseControlSet} do {
		if (getDammage uwg_cruise > 0.1) exitWith {
			...
			hint parseText format [""
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Tempomat</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Cruise Control:</t><t size='0.90 'font='puristaLight' align='left' color='#990000'> Deaktiviert!</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Das Fahrzeug ist zu sehr beschädigt, reparieren Sie es!<br/><br/>
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>- Tempomatstatus -</t><br/>""
							];
		};
		if (fuel uwg_cruise < 0.1) exitWith {
			...
			hint parseText format [""
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Tempomat</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Cruise Control:</t><t size='0.90 'font='puristaLight' align='left' color='#990000'> Deaktiviert!</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Das Fahrzeug hat nicht mehr genug Sprit.<br/><br/>
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>- Tempomatstatus -</t><br/>""
							];
		};
