...
BTC_active_cargo     = 0;
//Common
BTC_dir_action = "addons\=BTC=_logistic\=BTC=_addAction.sqf";
...
if (BTC_active_lift == 1) then
{
	...
	_lift = [] execVM "addons\=BTC=_logistic\=BTC=_lift\=BTC=_lift_init.sqf";
...
if (BTC_active_fast_rope == 1) then
{
	...
	_rope = [] execVM "addons\=BTC=_logistic\=BTC=_fast_roping\=BTC=_fast_roping_init.sqf";
};
if (BTC_active_cargo == 1) then
{
	//Cargo System
	_cargo = [] execVM "addons\=BTC=_logistic\=BTC=_cargo_system\=BTC=_cargo_system_init.sqf";
