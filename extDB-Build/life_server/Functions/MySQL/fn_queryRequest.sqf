...
_query = switch(_side) do {
	...
	case independent: {_returnCount = 10; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, aliases, med_licenses, mediclevel, med_gear FROM players WHERE playerid='%1'",_uid];};
