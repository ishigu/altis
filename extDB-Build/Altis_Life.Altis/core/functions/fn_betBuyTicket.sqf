...
_action = [
	parseText format["Ein Lotterieticket kostet $50.000.<br/><br/>Hinweis: Wenn Text eingegeben wurde, kann die korrekte Ausfüllung des Tickets nicht garantiert werden!"],
	"Altis Lotterie",
...
if(_action) then {
	if(life_atmcash < 50000) exitWith {hint localize "STR_NOTF_NotEnoughFunds";}; 
	if (life_atmcash >= 50000) then 
	{
