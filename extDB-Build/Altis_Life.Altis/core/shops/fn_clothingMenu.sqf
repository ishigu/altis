...
//Cop / Civ Pre Check
if((_this select 3) in ["bruce","dive","criminal","kart"] && !(playerSide in [civilian,east])) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
if((_this select 3) == "reb" && !license_civ_rebel && playerSide != east) exitWith {hint localize "STR_Shop_NotaReb"; closeDialog 0;};
