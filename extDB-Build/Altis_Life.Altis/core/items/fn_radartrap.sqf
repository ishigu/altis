...
life_action_radarTrapDeploy = player addAction["<t color='#00FF00'>Blitzer aufstellen</t>",{if(!isNull life_radarTrap) then {detach life_radarTrap; life_radarTrap = ObjNull;}; player removeAction life_action_radarTrapDeploy; life_action_radarTrapDeploy = nil;},"",999,false,false,"",'!isNull life_radarTrap && playerSide== west'];
