...
switch (typeOf _building) do {
	case "Land_Dome_Big_F": {_cpRate = 0.0015;};
	case "Land_Research_house_V1_F": {_cpRate = 0.00085;};
...
[[getPlayerUID player,profileName,"65"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
