...
switch (_shop) do
{
	...
	case "cop": {["Polizeibedarf",["donuts","coffee","spikeStrip","water","rabbit","apple","redgull","fuelF","barrier","pylon","radartrap","ghilliepack","defusekit","dogfood","handcuffs","radarreader"]]};
